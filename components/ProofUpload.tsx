...
export default function ProofUpload({ onUploadComplete, onError }: ProofUploadProps) {
  ...
  function handleUpload(file: File) {
    ...
    xhr.open('POST', '/api/upload-pitch-proof');
    ...
    <div>
      ...
      >
        ...
        <div style={{ marginBottom: '0.75rem' }}>
          {/* Document-outline icon — distinguishes proof from video upload */}
