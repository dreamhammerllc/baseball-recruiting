      ...
      <main style={{ flex: 1, padding: '2rem 2.5rem', overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '640px' }}>
          {[
            ...
            { label: 'Subscription', desc: 'Manage your plan and billing', icon: '💳', href: '/pricing' },
            { label: 'Notifications', desc: 'Control email and in-app alerts', icon: '🔔' },
            { label: 'Privacy', desc: 'Control who can view your profile', icon: '🔒' },
